        ...
        <tr>
         ...
         <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="SqlConDue" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT codDue, nombreDue + ' ' + apellidoDue AS Nombre FROM DUEÑO"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            <td class="text-right">
